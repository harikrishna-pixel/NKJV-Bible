...
return 'Daily verses, inspiration & behind the scenes.';
}
if (key.contains('facebook') || label.contains('facebook')) {
return 'Join our community and stay updated with the latest.';
}
if (key.contains('whatsapp') || label.contains('whatsapp')) {
return 'Join our WhatsApp community for updates and encouragement.';
}
if (key.contains('telegram') || label.contains('telegram')) {
return 'Get notifications, resources and special announcements.';
}
