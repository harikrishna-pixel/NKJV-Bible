...
class _UnderLineScreenState extends State<UnderLineScreen> {
  ...
  // Check version and navigate to read the underline
  void _navigateToRead(BookMarkModel data) async {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Description
                Text(
                  'This underline was saved in "${BibleInfo.getBibleVersionDisplayName(itemVersion)}".\n\n'
            ...
            if (items != null && items.isNotEmpty) {
              ...
              return const SizedBox.expand(
                child: LibraryEmptyState(
                  ...
                  title: 'No Underlines Yet',
                  subtitle:
                      'Underline verses while reading to access them anytime.',
                ),
              );
            }
          }),
