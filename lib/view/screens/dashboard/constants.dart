class BibleInfo {
  static String apple_AppId = "6459793497";

  // 6484270584  //6459793603
  static String ios_Bundle_Id = "com.balaklrapps.nivbible";
  static String bible_shortName = "NIV Bible";
  static String current_Version = "1.0.132";
  static String android_Package_Name = "com.whitebibles.genevabible";
  static String appID = '1894f822-ed0b-11ef-b28e-fa163e8c011b';
  ...
  static String exitOfferPlanid = 'com.balaklrapps.nivbible.lifetime.exitoffer';
  ...
  // Coin Pack IDs
  static String coinPack1Id = 'com.balaklrapps.nivbible.creditpack1';
  static String coinPack2Id = 'com.balaklrapps.nivbible.creditpack2';
  static String coinPack3Id = 'com.balaklrapps.nivbible.creditpack3';
  ...
  // Ads IDs - iOS
  static String adsGoogleBannerIdIos = "ca-app-pub-4194577750257069/1833695536";
  static String adsGoogleBannerId_2Ios = "";
  static String adsGoogleBannerId_3Ios = "";
  static String adsGoogleInterstitialIdIos =
      "ca-app-pub-4194577750257069/2516221817";
  static String adsGoogleRewardIdIos = "ca-app-pub-4194577750257069/3946505943";
  static String adsGoogleOpenAppIdIos =
      "ca-app-pub-4194577750257069/2282124389";
  static String adsGoogleNativeIdIos = "ca-app-pub-4194577750257069/9263579059";
