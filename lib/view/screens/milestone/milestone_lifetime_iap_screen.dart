...
/// Purchase flow reuses existing [SubscriptionScreen] with lifetime pre-selected.
class MilestoneLifetimeIapScreen extends StatelessWidget {
  const MilestoneLifetimeIapScreen({super.key, required this.kind});

  final MilestoneLifetimeKind kind;

  Future<void> _openExistingPaywallWithLifetimeSelected(BuildContext context) async {
    ...
    final checkad = kind == MilestoneLifetimeKind.scripture
  ...
  Widget build(BuildContext context) {
    ...
    final isScripture = kind == MilestoneLifetimeKind.scripture;
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Text.rich(
                      TextSpan(
                        ...
                        children: [
                          const TextSpan(text: 'A one-time offering to support your '),
                          TextSpan(
                            text: isScripture ? 'journey' : 'daily prayer',
                            style: const TextStyle(fontWeight: FontWeight.w700),
                          ),
                        ],
                      ),
              ...
              ElevatedButton(
                onPressed: () => _openExistingPaywallWithLifetimeSelected(context),
